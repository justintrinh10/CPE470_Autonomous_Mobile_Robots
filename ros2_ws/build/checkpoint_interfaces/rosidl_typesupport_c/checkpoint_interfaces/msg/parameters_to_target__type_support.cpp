...
static const _ParametersToTarget_type_support_symbol_names_t _ParametersToTarget_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, checkpoint_interfaces, msg, ParametersToTarget)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, checkpoint_interfaces, msg, ParametersToTarget)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, checkpoint_interfaces, msg, ParametersToTarget)() {
  return &::checkpoint_interfaces::msg::rosidl_typesupport_c::ParametersToTarget_message_type_support_handle;
}
